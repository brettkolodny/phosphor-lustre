...
// build/dev/javascript/phosphor_lustre/phosphor.mjs
function lightning_fill(attrs) {
  let base_attributes = prepend(
    ...
    prepend(
      ...
      prepend(
        ...
        prepend(
          ...
          prepend(attribute("viewBox", "0 0 256 256"), attrs)
        )
      )
    )
  );
  let combined_attributes = concat(toList([base_attributes, attrs]));
  return svg(
    combined_attributes,
    toList([
      path(
  ...
  let app = element2(
    div(
      ...
      toList([
        ...
        lightning_fill(toList([attribute("width", "4em")]))
      ])
    )
  );
